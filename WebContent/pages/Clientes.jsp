                        ...
                        <div class="col-xs-12">
                            <div class="box box-default">
                                <div class="box-header with-border">
                                    ...
                                    <a class="btn btn-primary btn-sm" href="clienteControle?acao=incluir">
                                                            ...
                                                            <c:forEach var="c" items="${listar}">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>${c.email}</td>
																		<td>${c.telefone}</td>
                                                                        <td><a class="btn btn-warning btn-sm" href="clienteControle?acao=alterar&id=${c.id}">
                                                                            <span class="glyphicon glyphicon-edit"></span> Editar</a>
                                                                            <a class="btn btn-danger btn-sm" href="javascript:confirmaExclusao(${c.id})">
