...
public class ItemDAO extends GeralDAO {

    private static final String INSERT = "insert into Item (idCliente, total) values (?,?);";
    private static final String DELETE = "delete from Item where idPedido = ?;";
    private static final String UPDATE = "update Item set idCliente=?, total=? where idPedido = ?;";
    private static final String SELECT_ALL = "select * from Item order by idPedido;";
    private static final String SELECT_BY_ID = "select * from Item where idProduto = ? order by idPedido;";
    private static final String SELECT_QTD = "select count(*) as qtd from Item;";
